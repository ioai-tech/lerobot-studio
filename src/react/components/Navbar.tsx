...
import { supportsHandlePersistence, isSampleDatasetsConfigured } from '@/platform';
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-background">
        ...
        <div className="flex items-center gap-2 mr-auto">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="min-w-[200px]">
              ...
              {samplesConfigured && onOpenSample && (
                <>
                  <DropdownMenuSeparator />
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          <div className="flex items-center gap-1">
            <Tooltip>
              ...
              <TooltipContent>{t('navbar.github')}</TooltipContent>
            </Tooltip>
            <LanguageToggle />
            <ThemeToggle />
          </div>
      ...
      {(activeTask || percent !== undefined) && (
        <div
          className="absolute bottom-0 left-0 w-full h-[2px] bg-muted overflow-hidden"
          role="progressbar"
