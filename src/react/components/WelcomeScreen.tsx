      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <motion.div className="text-center mb-16 space-y-6" variants={itemVariants}>
            <a
              href={t('panels.welcome.banner.url')}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium hover:bg-primary/20 transition-colors"
            >
              <span>{t('panels.welcome.banner.text')}</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Right Column: Get Started / Input */}
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <div className="text-center pt-8">
                <p className="text-xs text-muted-foreground" data-readability>
                  {t('panels.welcome.copyright', { year: new Date().getFullYear() })}
                </p>
              </div>
            </motion.div>
          </div>
