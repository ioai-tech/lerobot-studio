      ...
      alias: [
        {
          ...
          replacement: path.resolve(
            __dirname,
            '../../packages/react/src/i18n/reactI18nextCompat.ts',
          ),
        },
        {
          find: /^@ioai\/lerobot-studio$/,
          replacement: path.resolve(__dirname, '../../packages/react/src/index.ts'),
        },
        {
          find: /^@ioai\/lerobot-studio-core$/,
          replacement: path.resolve(__dirname, '../../packages/core/src/index.ts'),
        },
        {
          find: /^@ioai\/lerobot-studio-platform$/,
          replacement: path.resolve(__dirname, '../../packages/platform/src/index.ts'),
        },
        {
          find: /^@ioai\/lerobot-studio-ui$/,
