...
try {
  ...
  await writeFile(
    ...
    [
      "import { LeRobotViewer, createArchiveDataSourceFromFile, createArchiveDataSourceFromUrl } from '@ioai/lerobot-studio';",
      "import type { DataSource, LeRobotViewerProps } from '@ioai/lerobot-studio';",
