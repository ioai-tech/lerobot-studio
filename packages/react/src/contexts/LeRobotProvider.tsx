...
import { DirectoryDataSource } from '@ioai/lerobot-studio-platform';
...
import {
  ...
  type ParquetImageServiceImpl,
} from '@ioai/lerobot-studio-platform';
import { getImageFeatureNames } from '@ioai/lerobot-studio-core';
    ...
    async (dataSource: DataSource | FileSystemDirectoryHandle) => {
      ...
      try {
        ...
        const { LeRobotDataLoader: LeRobotDataLoaderCtor } =
          await import('@ioai/lerobot-studio-platform');
