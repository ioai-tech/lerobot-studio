...
} from '../apps/web/src/services/SourceController';
import type { DataSource } from '@ioai/lerobot-studio-platform';
import type { HistoryItem } from '@ioai/lerobot-studio';
import * as handleStore from '../packages/platform/src/utils/handleStore.ts';
import * as fsPermissions from '../packages/platform/src/utils/fsPermissions.ts';
import * as archiveFactory from '../packages/platform/src/datasource/ArchiveDataSourceFactory.ts';
import * as remotePreflight from '../packages/platform/src/datasource/remotePreflight.ts';
import { parseSourceUrl } from '../apps/web/src/utils/sourceUrl';

vi.mock('../packages/platform/src/utils/handleStore.ts', () => ({
...
vi.mock('../packages/platform/src/utils/fsPermissions.ts', () => ({
  supportsHandlePersistence: vi.fn(() => true),
  verifyPermission: vi.fn(),
}));

vi.mock('../packages/platform/src/datasource/ArchiveDataSourceFactory.ts', async () => {
  const actual = await vi.importActual<
    typeof import('../packages/platform/src/datasource/ArchiveDataSourceFactory.ts')
...
vi.mock('../packages/platform/src/datasource/remotePreflight.ts', async () => {
  const actual = await vi.importActual<
    typeof import('../packages/platform/src/datasource/remotePreflight.ts')
  >('../packages/platform/src/datasource/remotePreflight.ts');
  return {
    ...actual,
