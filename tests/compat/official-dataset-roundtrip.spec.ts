...
vi.mock('../../packages/platform/src/export/parquetWasmLoader.ts', async () => {
...
import { ExportService, LeRobotDataLoader } from '@ioai/lerobot-studio-platform';
...
describe.skipIf(!python)('official LeRobot dataset compatibility', () => {
  it('loads a Studio v2-to-v3 numeric export with LeRobotDataset', async () => {
  ...
  it('loads a Studio v2-to-v3 MP4 export and resolves the official video paths', async () => {
