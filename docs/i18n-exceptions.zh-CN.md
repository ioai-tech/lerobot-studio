...
> **Language / 语言：** [English](/i18n-exceptions) | [简体中文](./i18n-exceptions)
...
| 路径                        | 原因                                                 | 中文入口                                                  |
| --------------------------- | ---------------------------------------------------- | --------------------------------------------------------- |
| `etc/lerobot-studio.api.md` | API Extractor 输出；用 `npm run api:report` 重新生成 | [`docs/api.zh-CN.md`](./api) 以中文说明包裹同一份英文报告 |
...
3. 在本页与 [`i18n-exceptions.zh-CN.md`](./i18n-exceptions) 中记录该例外。
