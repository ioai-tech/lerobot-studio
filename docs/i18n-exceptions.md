...
> **Language / 语言：** [English](./i18n-exceptions.md) | [简体中文](/zh-CN/i18n-exceptions)
...
| --------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `etc/lerobot-studio.api.md` | API Extractor output; regenerate with `npm run api:report` | [`docs/api.zh-CN.md`](/zh-CN/api) wraps the same English report with Chinese guidance |
...
3. Document the exception on this page and in
   [`i18n-exceptions.zh-CN.md`](/zh-CN/i18n-exceptions).
